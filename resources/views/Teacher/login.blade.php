...
<div class="login-page-wrap">
    <div class="login-page-content bg-white">
        <div class="login-box" style="background-color: #030C3D">
            ...
            <form action="{{ route('teacher.login') }}" method="post" class="login-form text-white">
                @csrf
                <div class="form-group">
                    <label class="text-white">Email</label>
                    <input type="text" placeholder="Enter Email" value="teacher@gmail.com" name="email" class="text-white form-control @error('email') is-invalid @enderror">
