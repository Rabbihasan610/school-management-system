...
<head>
  ...
  <title> {{ $settings->website_name }} |Student Login</title>
...
<div class="login-page-wrap">
  <div class="login-page-content bg-white">
      <div class="login-box" style="background-color: #030C3D">
          ...
          <form action="{{ route('sms.login') }}" method="post" class="login-form text-white">
              @csrf
              <div class="form-group">
                  <label class="text-white">Email</label>
                  <input type="text" placeholder="Enter Email" name="email" value="sakib@gmail.com" class="text-white form-control @error('email') is-invalid @enderror">
