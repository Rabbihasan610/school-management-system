...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="">
                <form id="contact_form" method="post" action="{{ route('admin.accountant.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            <div class="form-group">
                                <label for="teacherName">Accountant Name <span style="color: red;">*</span></label>
                   ...
                   <div class="row">
                    <div class="col-lg-12 form-group">
                        ...
                        <input type="text" name="salary" id="qualification" class="form-control" placeholder="">
                    </div>
                   </div>
                    <div class="row">
                        <div class="col-lg-12">
