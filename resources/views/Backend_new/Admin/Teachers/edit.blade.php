...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="">
                <form id="contact_form" method="post" action="{{ route('teacher.update') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="salary" value="{{ $edit->salary }}" id="phone" class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
                    {{-- <div class="row">
