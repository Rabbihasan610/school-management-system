...
<div class="login-page-wrap">
  <div class="login-page-content bg-white">
      <div class="login-box" style="background-color: #030C3D">
          ...
          <form action="{{ route('admin.check.otp') }}" method="post" class="login-form text-white">
              @csrf
              <div class="form-group">
                  <label class="text-white">OTP</label>
                  <input type="text" placeholder="Enter otp" name="otp" class="text-white form-control @error('otp') is-invalid @enderror">
              ...
              @enderror
              <div class="form-group">
                  <button type="submit" class="login-btn text-white">OTP Send</button>
              </div>
          </form>
