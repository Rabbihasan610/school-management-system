...
<div class="login-page-wrap">
  <div class="login-page-content bg-white">
      <div class="login-box" style="background-color: #030C3D">
          ...
          <form action="{{ route('admin.send') }}" method="post" class="login-form text-white">
              @csrf
              <div class="form-group">
                  <label class="text-white">Email</label>
                  <input type="text" placeholder="Enter Email" name="email" class="text-white form-control @error('email') is-invalid @enderror">
              ...
              @enderror
              <div class="form-group">
                  <button type="submit" class="login-btn text-white">Send</button>
              </div>
          </form>
