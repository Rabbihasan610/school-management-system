    ...
    <div class="card-body">
        <div class="heading-layout1">
            <div class="item-title">
                <h3>Student Attendace Serach</h3>
            </div>
            <div class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @endphp
                <form
                    action="{{ route('admin.dailyAttendance.store') }}" method="POST">
                    @csrf
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <div class="form-check pr-5">
                                                    ...
                                                    <input type="checkbox" name="attendance[]" value="present" id="checkPresent" class="form-check-input" data-id="{{ $attendance->id }}">
                                                    <label class="form-check-label" for="flexCheckChecked">
                                                        Present
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" name="attendance[]" id="checkAbsent" value="absent" class="form-check-input"  data-id="{{ $attendance->id }}">
                                                    <label class="form-check-label" for="flexCheckChecked">
                                                        Absent
                                                    </label>
                                                </div>
