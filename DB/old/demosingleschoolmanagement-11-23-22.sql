...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2022 at 09:46 AM
...
--
-- Database: `demosingleschoolmanagement`
--

-- --------------------------------------------------------

--
-- Table structure for table `2019-2020_2_students`
--

CREATE TABLE `2019-2020_2_students` (
...
--
-- Dumping data for table `2019-2020_2_students`
--

INSERT INTO `2019-2020_2_students` (`id`, `student_id`, `roll`, `image`, `stu_name`, `class`, `section`) VALUES
(1, 17, '100', 'assets/backend/img/student/636b28dc53a9bimages (4).jpg', 'Lila Clark', '2', 3),
(2, 18, '101', 'assets/backend/img/student/636b29f49fddaimages (4).jpg', 'Keiko Crawford', '2', 3),
(3, 19, '102', 'assets/backend/img/student/636b2a4cdc5e9images (3).jpg', 'Leah Hull', '2', 3);
...
(1, 20, '300', 'assets/backend/img/student/636b2aa30bd8eimages (4).jpg', 'Jasper Nunez', '3', '5'),
(2, 21, '301', 'assets/backend/img/student/636b2ae9ccebfimages (2).jpg', 'Chester Crosby', '3', '5');
...
(1, 22, '401', 'assets/backend/img/student/636b2bb0a3480download (1).jpg', 'Sydnee Holden', '4', '6'),
(2, 23, '402', 'assets/backend/img/student/636b2c092d712images (5).jpg', 'Rae Delacruz', '4', '6'),
(3, 24, '403', 'assets/backend/img/student/636b2c397387dimages (2).jpg', 'Astra Mcleod', '4', '6');
...
(1, 25, '501', 'assets/backend/img/student/636b2c7c91d6cimages (5).jpg', 'Damon Warner', '5', '7'),
(2, 26, 'Grant Acosta', 'assets/backend/img/student/636b2cc0853a9download (2).jpg', 'Kimberley Bryan', '5', '8'),
(3, 27, '503', 'assets/backend/img/student/636b2cf716b5dimages (2).jpg', 'Aurora Orr', '5', '9');
...
(1, 28, '201', 'assets/backend/img/student/636b2d310bf84download (3).jpg', 'Alexandra Moore', '2', '3'),
(2, 29, '202', 'assets/backend/img/student/636b2d737c3dcimages (2).jpg', 'Philip Pope', '2', '3'),
(3, 30, '203', 'assets/backend/img/student/636b2d9e96b08images (3).jpg', 'Mari Duran', '2', '3'),
(4, 31, '204', 'assets/backend/img/student/636b2ddaa7a71images (2).jpg', 'Rahim Marsh', '2', '3');
...
(1, 32, '301', 'assets/backend/img/student/636b2e03063d4images (2).jpg', 'Raymond Johnston', '3', '5'),
(2, 33, '302', 'assets/backend/img/student/636b2e7f4018edownload (3).jpg', 'Zeph Haley', '3', '5'),
(3, 34, '303', 'assets/backend/img/student/636b2effe081cimages (3).jpg', 'Ezra Cotton', '3', '5');
...
(1, 35, '401', 'assets/backend/img/student/636b2f30cba03images (1).jpg', 'Kiona Hull', '4', '6'),
(2, 36, '402', 'assets/backend/img/student/636b2fc92dbf0images (4).jpg', 'Bernard Ellis', '4', '6'),
(3, 37, '403', 'assets/backend/img/student/636b2ffcc4b3fimages (2).jpg', 'Ira Mclaughlin', '4', '6');
...
(1, 38, '501', 'assets/backend/img/student/636b30339e140images (5).jpg', 'Imogene Palmer', '5', '7'),
(2, 39, '502', 'assets/backend/img/student/636b3063b05fbimages (2).jpg', 'Mark Peterson', '5', '8'),
(3, 40, '503', 'assets/backend/img/student/636b30a677340download (2).jpg', 'Kasper Downs', '5', '9');
...
(1, 41, '201', 'assets/backend/img/student/636b30fa35f77images (3).jpg', 'Rowan Donaldson', '2', '3'),
(2, 42, '202', 'assets/backend/img/student/636b312869695images (3).jpg', 'Odette Hughes', '2', '3');

-- --------------------------------------------------------

--
-- Table structure for table `2021-2022_5_students`
--

CREATE TABLE `2021-2022_5_students` (
  `id` int(10) UNSIGNED NOT NULL,
  `student_id` bigint(20) UNSIGNED DEFAULT NULL,
  `roll` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `2021-2022_5_students`
--

INSERT INTO `2021-2022_5_students` (`id`, `student_id`, `roll`, `image`, `stu_name`, `class`, `section`) VALUES
(1, 43, '501', 'assets/backend/img/student/636b315da6416images (3).jpg', 'Irma Lawrence', '5', '7');
...
INSERT INTO `accountants` (`id`, `role_id`, `name`, `school_id`, `designation`, `dob`, `gender`, `address`, `qualification`, `phone`, `email`, `password`, `department`, `fb`, `twitter`, `linkden`, `subject`, `image`, `status`, `created_at`, `updated_at`) VALUES
(1, 6, 'Accountant', NULL, 'Illo sed quibusdam i', '1996-10-02', 'female', 'Vel officia nostrud', 'Bsc', '+1 (255) 476-7547', 'accountant@example.com', '$2y$10$OsYjFaP8/xpuyvodKgwVzeSsQuOjiikSIJQmaBRJfK/VOl0K.qC4W', 'Voluptas minima quid', 'Est commodi ex quia', 'Nisi qui voluptas il', 'Fuga Facilis laboru', NULL, 'assets/backend/teacher/6379fee50f1b1download.jpg', '1', '2022-11-20 04:18:13', '2022-11-20 04:26:31');
...
INSERT INTO `banners` (`id`, `headings`, `short_description`, `email`, `phone`, `image`, `status`, `created_at`, `updated_at`) VALUES
(13, 'Quality Education School & College 1', NULL, 'c11@gmail.com', '14785236978', 'assets/backend/img/banner/6350d0d4e4c9c360F427160582w0D5Z01pVaz32w7JzzNWTtE2n1VvvKmi1920x576.jpg', 1, '2022-10-19 22:38:46', '2022-10-19 22:41:05'),
(14, 'Quality Education School & College 2', NULL, 'c11@gmail.com', '78945612322', 'assets/backend/img/banner/6350d109855f9pexelsphoto8427111920x576.jpg', 1, '2022-10-19 22:39:38', '2022-10-19 22:40:22'),
(15, 'Quality Education School & College 3', NULL, 'c11@gmail.com', '12345679855', 'assets/backend/img/banner/6350d12de9af93977451920x576.jpg', 1, '2022-10-19 22:40:14', '2022-10-19 22:40:27');
...
INSERT INTO `book_categories` (`id`, `category_name`, `description`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Golpo', 'Golpo', 1, '2022-11-18 05:52:13', '2022-11-18 05:52:13');
...
INSERT INTO `classes` (`id`, `class_name`, `class_name_numeric`, `teacher_id`, `created_at`, `updated_at`) VALUES
(2, 'Class Two', 2, 1, '2022-11-03 00:02:07', '2022-11-03 00:02:07'),
(3, 'Class Three', 3, 1, '2022-11-03 00:02:22', '2022-11-03 00:02:22'),
(4, 'Class Four', 4, 1, '2022-11-03 00:02:42', '2022-11-03 00:02:42'),
(5, 'Class Five', 5, 1, '2022-11-03 00:02:54', '2022-11-03 00:02:54'),
(7, 'Class Six', 6, 1, '2022-11-03 03:27:13', '2022-11-03 03:27:13'),
(8, 'Class Seven', 7, 0, '2022-11-03 03:27:29', '2022-11-03 03:27:29'),
(9, 'Class Eight', 8, 1, '2022-11-03 03:27:44', '2022-11-03 03:27:44'),
(10, 'Class nine', 9, 1, '2022-11-03 03:27:58', '2022-11-03 03:27:58'),
(11, 'Class Ten', 10, 0, '2022-11-03 03:28:10', '2022-11-07 05:01:01');
...
(1, 'Step-5', 'st-1234', '1', '2022-10-20 00:17:10', '2022-10-20 00:17:10'),
(2, 'step-3', 'st-1235', '1', '2022-10-20 00:17:44', '2022-10-20 00:17:44'),
(3, 'step-4', 'st-1236', '1', '2022-10-20 00:18:29', '2022-10-20 00:18:29'),
(4, 'Step-6', 'st-1237', '1', '2022-10-20 00:18:41', '2022-10-20 00:19:39'),
(6, 'Thomas Harrison', 'Excepturi nobis cupi', '1', '2022-11-07 03:13:22', '2022-11-07 03:14:12');
...
INSERT INTO `events` (`id`, `title`, `image`, `details`, `event_date`, `status`, `created_at`, `updated_at`) VALUES
(3, 'Friday Holyday', 'assets/backend/img/event/6335da7baba031.png', '<p>The VSI International School aims at all round personality development of the students, who learn to give and receive respect, as they are groomed into citizens not only of this country but also of the world.</p>', '2022-09-30', 1, '2022-09-29 11:48:43', '2022-09-29 11:48:43'),
...
INSERT INTO `galleries` (`id`, `title`, `title_image`, `total_image`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Image gallery', 'assets/backend/img/gallery/6350dbd21fedf360_F_427160582_w0D5Z01pVaz32w7JzzNWTtE2n1VvvKmi.jpg', 3, 1, '2022-10-19 23:25:38', '2022-10-19 23:26:07'),
(2, 'Holiday', 'assets/backend/img/gallery/63511a9cf0258download (3).jpg', 2, 1, '2022-10-20 03:53:33', '2022-10-20 03:53:34'),
(3, 'Pohela boishak', 'assets/backend/img/gallery/63511adfa5362download (3).jpg', 4, 1, '2022-10-20 03:54:39', '2022-10-20 03:54:41');
...
INSERT INTO `gallery_images` (`id`, `gallery_id`, `gallery_image`, `created_at`, `updated_at`) VALUES
(3, 1, 'assets/backend/img/gallery/6350dbd266d8fimages (2).jpg', '2022-10-19 23:25:38', '2022-10-19 23:25:38'),
(4, 1, 'assets/backend/img/gallery/6350dbd2a5c57images.jpg', '2022-10-19 23:25:38', '2022-10-19 23:25:38'),
(5, 1, 'assets/backend/img/gallery/6350dbed24902397745.jpg', '2022-10-19 23:26:06', '2022-10-19 23:26:06'),
(6, 2, 'assets/backend/img/gallery/63511a9d6d6dadownload (2).jpeg', '2022-10-20 03:53:33', '2022-10-20 03:53:33'),
(7, 2, 'assets/backend/img/gallery/63511a9dc4a60download (3).jpeg', '2022-10-20 03:53:34', '2022-10-20 03:53:34'),
(8, 3, 'assets/backend/img/gallery/63511adfefec7download (1).jpg', '2022-10-20 03:54:40', '2022-10-20 03:54:40'),
(9, 3, 'assets/backend/img/gallery/63511ae04583ddownload (2).jpg', '2022-10-20 03:54:40', '2022-10-20 03:54:40'),
(10, 3, 'assets/backend/img/gallery/63511ae0ac42ddownload.jpg', '2022-10-20 03:54:40', '2022-10-20 03:54:40'),
(11, 3, 'assets/backend/img/gallery/63511ae1005f1images.jpg', '2022-10-20 03:54:41', '2022-10-20 03:54:41');
...
INSERT INTO `general_settings` (`id`, `website_name`, `footer`, `email`, `phone`, `fax`, `address`, `latitude`, `longitude`, `logo`, `favicon`, `created_at`, `updated_at`) VALUES
(1, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Druto School © DrutoSoft 2022', 'ashad@gmail.com', '12456789', NULL, 'GMMV+RQ5, Mohitnagar, Jalpaiguri, West Bengal 735101, India', 4587.36, 87778.3, 'assets/backend/img/general_settings/636be05ed87ddSK-School-Logo.png', 'assets/backend/img/general_settings/6305f18739601Favicon.png', NULL, '2022-11-09 11:16:14');
...
INSERT INTO `issu_books` (`id`, `book_name`, `name`, `phone`, `address`, `num_of_copy`, `issue_date`, `return_date`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'Elmo Hardy', '+1 (834) 619-1701', 'Voluptas veniam vol', 4, '1976-01-25', NULL, 1, '2022-11-18 09:42:55', '2022-11-18 11:33:59'),
(2, 2, 'Martina Tillman', '+1 (408) 522-6253', 'Aperiam do dolor lab', 5, '2012-05-26', NULL, 1, '2022-11-18 11:14:02', '2022-11-18 11:34:44'),
(3, 4, 'Hasan', '12345678904', 'Dhaka', 5, '2022-11-19', NULL, 1, '2022-11-19 10:08:03', '2022-11-19 10:09:09');
...
INSERT INTO `librarians` (`id`, `role_id`, `name`, `email`, `phone`, `image`, `gender`, `dob`, `status`, `email_verified_at`, `password`, `deleted_at`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 3, 'Librarian', 'librarian@example.com', NULL, NULL, NULL, NULL, 1, NULL, '$2y$10$r0bM7hsEf7Mg0uM8FIiiU.VvqEa09rYa6xJKt0MNlysDBOi0L17hu', NULL, NULL, '2022-11-17 21:59:25', '2022-11-17 21:59:25');
...
INSERT INTO `library_books` (`id`, `book_category`, `self_no`, `book_name`, `author`, `description`, `price`, `quantity`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'Consequatur qui quis', 'Lewis Rodriguez', 'Natus voluptates nih', 'In inventore molesti', 700.00, '14', 1, '2022-11-18 05:53:56', '2022-11-18 11:33:59'),
(2, 1, 'Ipsa consequatur in', 'Hayden Bradley', 'Minim ut delectus e', 'Et voluptatem Omnis', 974.00, '6', 1, '2022-11-18 05:54:15', '2022-11-18 11:34:44'),
(3, 1, '12', 'Marquez', 'Est', 'Ad dolore est dicta', 500.00, '10', 1, '2022-11-19 10:05:34', '2022-11-19 10:05:34'),
(4, 1, '12', 'Marquez', 'Est', 'Ad dolore est dicta', 500.00, '10', 1, '2022-11-19 10:05:38', '2022-11-19 10:09:09'),
(5, 1, '12', 'Marquez', 'Est', 'Ad dolore est dicta', 500.00, '10', 1, '2022-11-19 10:05:40', '2022-11-19 10:05:40');
...
(53, '2022_11_02_044859_create_students_table', 16),
...
(64, '2022_11_07_044859_create_students_table', 17),
...
(129, '2022_11_20_081539_create_accountants_table', 25),
(130, '2022_11_23_055611_create_transports_table', 26);
...
INSERT INTO `notices` (`id`, `title`, `notice`, `status`, `created_at`, `updated_at`) VALUES
(4, 'Pending Document Verification For Graduate Programs – Spring 2022', 'assets/backend/notice/63368260bc926rabbi_cv.pdf', 1, '2022-09-29 23:45:04', '2022-09-29 23:45:04'),
(5, 'Pending Document Verification For Graduate Programs – Spring 2023', 'assets/backend/notice/6336827dc1580rabbi-hasan.pdf', 1, '2022-09-29 23:45:33', '2022-09-29 23:45:33'),
(6, 'Graduate Programs – Spring 2022', 'assets/backend/notice/6336828c8c59arabbi_cv.pdf', 1, '2022-09-29 23:45:48', '2022-09-29 23:45:48'),
(7, 'Verification For Graduate Programs', 'assets/backend/notice/633684a0b65d6rabbi-hasan.pdf', 1, '2022-09-29 23:54:40', '2022-09-29 23:54:40'),
(8, '2024 Verification For Graduate Programs', 'assets/backend/notice/633684afb1a64rabbi-hasan.pdf', 1, '2022-09-29 23:54:55', '2022-09-29 23:54:55'),
(9, '2025 Verification For Graduate Programs', 'assets/backend/notice/633684c420dbbrabbi_cv.pdf', 1, '2022-09-29 23:55:16', '2022-09-29 23:55:16');
...
INSERT INTO `session_years` (`id`, `session`, `created_at`, `updated_at`) VALUES
(3, '2019-2020', '2022-11-03 00:00:22', '2022-11-03 00:00:22'),
(4, '2020-2021', '2022-11-03 00:00:33', '2022-11-03 00:00:33'),
(5, '2021-2022', '2022-11-03 00:00:41', '2022-11-03 00:00:41');
...
INSERT INTO `social_settings` (`id`, `title`, `icon`, `url`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Facebook', 'fas fa-facebook', 'https://www.facebook.com/', 1, '2022-10-20 05:30:53', '2022-10-20 05:30:53'),
(2, 'Twitter', 'fa fa-twitter', 'www.twitter.com', 1, '2022-10-20 05:31:48', '2022-10-20 05:31:48'),
(3, 'Youtube', 'fas fa-youtube', 'www.youtube.com', 1, '2022-10-20 05:32:20', '2022-10-20 05:32:20');
...
INSERT INTO `students` (`id`, `school_id`, `institute_name`, `branch`, `course`, `trade`, `image`, `class_roll`, `class`, `group`, `technology`, `semester`, `session`, `student_name_eng`, `student_name_ban`, `student_phone_1`, `student_phone_2`, `father_name_eng`, `father_name_ban`, `father_phone_1`, `father_phone_2`, `mother_name_eng`, `mother_name_ban`, `mother_phone_1`, `mother_phone_2`, `zila`, `upzila`, `union`, `post`, `ward`, `village`, `para`, `g_zila`, `g_upzila`, `g_union`, `g_post`, `g_ward`, `g_village`, `g_para`, `loc_name`, `loc_relation`, `loc_phone`, `loc_zila`, `loc_upzila`, `loc_union`, `loc_post`, `loc_ward`, `loc_village`, `loc_para`, `hostel`, `full_course_fee`, `semester_fee`, `internship_fee`, `agreement`, `doc1`, `doc2`, `doc3`, `doc4`, `remarks`, `other_activities`, `student_sign`, `guardian_sign`, `admitted_by_sign`, `created_at`, `updated_at`) VALUES
(17, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Dhaka', '3', '2', 'assets/backend/img/student/636b28dc53a9bimages (4).jpg', '100', '2', '3', 'electrical', '1st Semester', '2019-2020', 'Lila Clark', 'Britanney Alston', '12345678', '12345678', 'Isadora Cline', 'Doris Kirk', '12345678', '12345678', 'Colton Mccray', 'Cadman Bishop', '12345678', '12345678', '50', '383', '3486', 'Dignissimos cupidata', 'Irure et quisquam na', 'Consectetur aliqua', 'Quo est velit sed el', '29', '227', '2059', 'Laboriosam molestia', 'Nemo aut sapiente qu', 'Voluptas aperiam ut', 'A cum vel earum aut', 'Ria Collins', 'Ima Maldonado', 'Rae Baldwin', '43', '330', '2964', 'Quaerat non eaque qu', 'Incididunt assumenda', 'Rem sequi aut mollit', 'Rerum eum quod ad qu', 0, 100000.00, 10000.00, 12000.00, 'Molestias voluptatem', 'assets/backend/img/student/file/636b28dcab88cphoto-1524069290683-0457abfe42c3.avif', 'assets/backend/img/student/file/636b28dcb2fc5photo-1527384025924-f30fc2ac98e3.avif', ' ', ' ', 'Velit explicabo Qu', 'Dicta natus deleniti', NULL, NULL, NULL, '2022-11-08 22:13:19', '2022-11-08 22:13:19'),
(18, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Maxwell Sparks', '2', '1', 'assets/backend/img/student/636b29f49fddaimages (4).jpg', '101', '2', '3', 'computer', '1st Semester', '2019-2020', 'Keiko Crawford', 'Dahlia Boyle', '123456', '123456', 'Bryar Christensen', 'Zenaida Young', '123456', '123456', 'Velma Ashley', 'Keith Cannon', '123456', '123456', '26', '205', '1869', 'Nobis aut magna nost', 'Rerum non dolor veli', 'Molestiae velit eum', 'Aperiam non voluptat', '17', NULL, NULL, 'Id reiciendis repreh', 'Culpa adipisicing ve', 'Molestiae laudantium', 'Amet est tempore l', 'Shellie Levine', 'Ila Ewing', 'Ruby Jennings', '9', NULL, '--- select union ---', 'Obcaecati beatae nos', 'Temporibus tempor ma', 'Commodi incidunt qu', 'Quaerat iusto saepe', 0, 1222.00, 222.00, 222.00, 'Deleniti assumenda l', ' ', ' ', ' ', ' ', 'In distinctio Et ni', 'Consequatur quia ips', NULL, NULL, NULL, '2022-11-08 22:17:56', '2022-11-08 22:17:56'),
(19, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Henry West', '2', '1', 'assets/backend/img/student/636b2a4cdc5e9images (3).jpg', '102', '2', '3', 'electrical', '1st Semester', '2019-2020', 'Leah Hull', 'Kay Palmer', 'Felix Roy', 'Kitra Jensen', 'Timothy Vaughan', 'Uriah Wise', 'Isaiah Dorsey', 'Ann Wilder', 'Wyatt Melendez', 'Noble Perez', 'Morgan Erickson', 'Rahim Austin', '45', '345', NULL, 'Incidunt minus sunt', 'Sunt aut quisquam a', 'Nostrud sed perspici', 'Modi commodo quo aut', '59', '440', NULL, 'Harum quibusdam et q', 'Nisi enim enim et qu', 'Minus rerum placeat', 'Vero ea velit sit a', 'Karyn Grant', 'Bevis Stein', 'Yoko Lucas', '8', '65', NULL, 'Quidem eius esse sol', 'Quia vel anim quis n', 'Assumenda enim minus', 'Architecto proident', 0, 12345.00, 4545.00, 4545.00, 'Et laboriosam disti', ' ', ' ', ' ', ' ', 'Quaerat atque debiti', 'Elit sed fugit dol', NULL, NULL, NULL, '2022-11-08 22:19:25', '2022-11-08 22:19:25'),
(20, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Dieter Russo', '4', '3', 'assets/backend/img/student/636b2aa30bd8eimages (4).jpg', '300', '3', '5', 'computer', '3rd Semester', '2019-2020', 'Jasper Nunez', 'Winter Fitzgerald', 'Clementine Yang', 'Kasper Delacruz', 'Preston Douglas', 'Sade Obrien', 'Robert Allison', 'Alexander Bell', 'Juliet Chaney', 'Nehru Strickland', 'Jonah Cochran', 'Glenna Oconnor', '53', '399', NULL, 'Iste aliquip est nu', 'Tempora voluptates d', 'In sunt aut aute tot', 'Corporis dolor ut il', '27', '206', NULL, 'Velit occaecat quod', 'Saepe tempor volupta', 'Doloribus quaerat hi', 'Excepteur tempora ip', 'Elizabeth Delgado', 'Vielka Hayes', 'George Daniels', '55', '417', NULL, 'Est vel pariatur Nu', 'Ex labore consectetu', 'Laboriosam veniam', 'Et aut exercitatione', 0, 54455.00, 445.00, 4554.00, 'Exercitation anim au', ' ', ' ', ' ', ' ', 'Distinctio Non dolo', 'Ea nostrum earum num', NULL, NULL, NULL, '2022-11-08 22:20:52', '2022-11-08 22:20:52'),
(21, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Denise Pugh', '2', '1', 'assets/backend/img/student/636b2ae9ccebfimages (2).jpg', '301', '3', '5', '--- select technology ---', '1st Semester', '2019-2020', 'Chester Crosby', 'Anika Nelson', 'Athena Howe', 'Zachery Ellis', 'Barrett Maddox', 'Zephr Rios', 'Declan Velasquez', 'Rajah Booth', 'Beau Bradley', 'Cadman Gonzalez', 'Lucian Harper', 'Pandora Rosario', '54', '404', NULL, 'Elit tenetur repreh', 'Odit dolore culpa se', 'Accusantium aliqua', 'Facilis fugiat cupid', '21', '179', NULL, 'Id enim nulla aspern', 'Non architecto nulla', 'Occaecat velit itaqu', 'Ut ex perspiciatis', 'Rhiannon Bond', 'Maggy Norman', 'Scarlet Cabrera', '57', '428', NULL, 'Saepe et veritatis m', 'Tenetur in quae expe', 'Deserunt totam culpa', 'Ut qui sapiente dolo', 0, 12123.00, 1232.00, 12323.00, 'Ipsum nulla nihil ra', 'assets/backend/img/student/file/636b2ae9f05e9images (3).jpg', ' ', ' ', ' ', 'Qui quo et in soluta', 'Et labore dolor cons', NULL, NULL, NULL, '2022-11-08 22:22:02', '2022-11-08 22:22:02'),
(22, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Tatiana Reeves', '1', '4', 'assets/backend/img/student/636b2bb0a3480download (1).jpg', 'Kylan Young', '4', '6', 'electrical', '2nd Semester', '2019-2020', 'Sydnee Holden', 'Jamal Mcfadden', 'Leandra Chaney', 'Ann Tyson', 'Jana Ortega', 'Maite Day', 'Caldwell Frederick', 'Melanie Berg', 'Alfreda Larson', 'Taylor Fulton', 'Hamilton Davis', 'Abbot Jacobs', '42', '322', NULL, 'Cupiditate officia l', 'Magni irure sint ea', 'Amet in dolores tem', 'A expedita laborum', '10', '88', NULL, 'Non esse sint dicta', 'Explicabo Laborum', 'Repudiandae qui simi', 'Consequatur eum labo', 'Marcia Chen', 'Jesse Barber', 'Zachery Tyson', '22', '186', NULL, 'Amet officia qui se', 'Qui reprehenderit o', 'Voluptas non ullam d', 'Dolor doloremque nos', 0, 213213.00, 123123.00, 1231.00, 'Quaerat est rem ad q', 'assets/backend/img/student/file/636b2bb0ba861photo-1547082661-71362fc3969c.avif', ' ', ' ', ' ', 'Quo corrupti qui qu', 'Eos Nam sunt accusa', NULL, NULL, NULL, '2022-11-08 22:25:22', '2022-11-08 22:25:22'),
(23, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Tara Leblanc', '1', '4', 'assets/backend/img/student/636b2c092d712images (5).jpg', '402', '4', '6', 'computer', '1st Semester', '2019-2020', 'Rae Delacruz', 'Justin Snyder', 'Delilah Sparks', 'Channing Savage', 'Chaney Houston', 'Wynne Simpson', 'Vielka Orr', 'Barrett Morris', 'Deanna Ware', 'Maisie Mcclain', 'Nero Edwards', 'Heather Lynch', '35', '266', NULL, 'Fugit magna praesen', 'Dolorum consequatur', 'Voluptatibus eu nihi', 'Officia ad iste ut q', '41', '317', NULL, 'Repellendus Ut ex q', 'Aut ipsum autem est', 'Omnis assumenda eos', 'Incidunt quidem dol', 'Hammett Howe', 'Addison Cunningham', 'Miranda Barker', '45', '345', NULL, 'Labore eius elit co', 'Quisquam omnis quis', 'Incididunt ea neque', 'Saepe quia dolor lor', 0, 21112.00, 1212.00, 1221.00, 'Officia quibusdam vo', ' ', ' ', ' ', ' ', 'Est et excepteur max', 'Obcaecati et ratione', NULL, NULL, NULL, '2022-11-08 22:26:49', '2022-11-08 22:26:49'),
(24, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Heather Stein', '1', '4', 'assets/backend/img/student/636b2c397387dimages (2).jpg', '403', '4', '6', 'computer', '2nd Semester', '2019-2020', 'Astra Mcleod', 'Hu Kidd', 'Rama Nash', 'Knox Flowers', 'Len Blackwell', 'Shoshana Reese', 'Xandra Vega', 'Berk Beach', 'Jenette Witt', 'Stephen Weeks', 'Alexander Jefferson', 'Martina Owens', '17', '150', NULL, 'Sunt sit sint iust', 'Assumenda ut et obca', 'Ex quam irure velit', 'Voluptatibus optio', '58', '435', NULL, 'Eum numquam nisi occ', 'Aut debitis tempora', 'Consectetur in simi', 'Et beatae doloremque', 'Gillian Merritt', 'Kamal Randolph', 'Alma Ware', '54', '404', NULL, 'Culpa dignissimos ei', 'Blanditiis ad eaque', 'Vel corrupti non mo', 'Obcaecati ea eaque v', 0, 12212.00, 12212.00, 1221.00, 'Tenetur tempora corr', ' ', ' ', ' ', ' ', 'Deserunt consequatur', 'Nulla libero dolorem', NULL, NULL, NULL, '2022-11-08 22:27:37', '2022-11-08 22:27:37'),
(25, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Martina Bray', '3', '2', 'assets/backend/img/student/636b2c7c91d6cimages (5).jpg', '501', '5', '7', 'electrical', '2nd Semester', '2019-2020', 'Damon Warner', 'Yael Parrish', 'Salvador Hopper', 'Marvin Robbins', 'Laurel Rodriguez', 'Quail Christensen', 'Mason Woods', 'Adria Benson', 'Macy Holland', 'Macon Sawyer', 'Guy Carson', 'Gay Soto', '55', '417', NULL, 'Consequatur minus in', 'Totam quis rem provi', 'Quaerat nostrum dolo', 'Eligendi ullam neque', '33', '249', NULL, 'Quis velit ullamco e', 'Dolor nostrud ipsum', 'Fuga Ut maxime labo', 'Doloremque veritatis', 'Barry Merritt', 'Vance Medina', 'Deirdre Neal', '61', '457', NULL, 'Voluptatem autem com', 'Eu ducimus voluptat', 'Quisquam qui magnam', 'Nisi et cupidatat mo', 0, 12122.00, 2121.00, 1212.00, 'Qui atque itaque del', ' ', ' ', ' ', ' ', 'Hic et nihil nulla q', 'Nihil sit voluptatum', NULL, NULL, NULL, '2022-11-08 22:28:46', '2022-11-08 22:28:46'),
(26, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Paul Slater', '1', '4', 'assets/backend/img/student/636b2cc0853a9download (2).jpg', 'Grant Acosta', '5', '8', 'computer', '1st Semester', '2019-2020', 'Kimberley Bryan', 'Kylan Park', 'Florence Anthony', 'Kristen Hamilton', 'Gareth Bradshaw', 'Francesca Cameron', 'Virginia Barron', 'Nash Lancaster', 'Kalia Craig', 'Shea Fletcher', 'Zeph Richmond', 'Callie Waters', '25', '196', NULL, 'Totam molestiae cill', 'Temporibus neque quo', 'Consectetur mollit o', 'Libero sit minim nob', '18', '155', NULL, 'Laudantium reprehen', 'Quae dolorum ipsam c', 'Iste maxime duis in', 'Incidunt ad error c', 'Chester Suarez', 'Naida Henson', 'Zenia Lancaster', '19', '160', NULL, 'Irure adipisicing qu', 'Enim mollitia atque', 'Excepteur illo paria', 'Labore culpa et culp', 0, 121212.00, 121212.00, 1212.00, 'Est dolor dolor iust', ' ', ' ', ' ', ' ', 'Dolores ullam offici', 'Maiores necessitatib', NULL, NULL, NULL, '2022-11-08 22:29:52', '2022-11-08 22:29:52'),
(27, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Adria Good', '2', '1', 'assets/backend/img/student/636b2cf716b5dimages (2).jpg', '503', '5', '9', 'computer', '--- select semester ---', '2019-2020', 'Aurora Orr', 'Dakota Castillo', 'Ann Whitfield', 'Murphy Mathews', 'Erich Peterson', 'Gillian Holloway', 'Bradley Mcguire', 'Chester Levine', 'Owen Murphy', 'Fitzgerald Mayo', 'Benedict Oconnor', 'Virginia Hansen', '53', '399', NULL, 'Modi aut ex et ut du', 'Sequi iusto ut labor', 'Excepteur delectus', 'Blanditiis sint sit', '1', '1', NULL, 'Officia officiis sim', 'Odit blanditiis aspe', 'Illum accusamus quo', 'Modi quasi porro dis', 'Jessica Peterson', 'Gay Justice', 'Seth Massey', '54', '404', NULL, 'Fugit quidem consec', 'Odio voluptates et p', 'Et voluptatem modi', 'Laboris eos praesent', 0, 454654.00, 56546.00, 645.00, 'Perspiciatis dolore', ' ', ' ', ' ', ' ', 'Voluptas dicta accus', 'Nulla dolor consequa', NULL, NULL, NULL, '2022-11-08 22:30:47', '2022-11-08 22:30:47'),
(28, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Jaquelyn Rollins', '3', '2', 'assets/backend/img/student/636b2d310bf84download (3).jpg', '201', '2', '3', '--- select technology ---', '3rd Semester', '2020-2021', 'Alexandra Moore', 'Shaeleigh Bowen', 'Brynn Middleton', 'Ciaran Mays', 'Claire Patterson', 'Yetta Fuller', 'Kermit Torres', 'Len Flowers', 'Rylee Greer', 'Lara Garner', 'Echo Roberson', 'Burton Holt', '7', '60', NULL, 'Dolore modi voluptat', 'Nostrum et fuga Tot', 'Irure a rerum deseru', 'Molestiae ipsum eli', '51', '385', NULL, 'Reprehenderit non of', 'Aut quam in assumend', 'Nesciunt dolor exce', 'Dolore eaque quidem', 'Rahim Farley', 'Indira Hendricks', 'Justina Vaughn', '31', '234', NULL, 'Beatae quia distinct', 'Sint a maxime commod', 'Nesciunt qui dolore', 'In provident ea ut', 0, 1212313.00, 313.00, 3121.00, 'Autem quia quo corpo', ' ', ' ', ' ', ' ', 'Voluptatum omnis ex', 'Adipisicing quasi ex', NULL, NULL, NULL, '2022-11-08 22:31:46', '2022-11-08 22:31:46'),
(29, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Nomlanga Stout', '1', '4', 'assets/backend/img/student/636b2d737c3dcimages (2).jpg', '202', '2', '3', 'electrical', '3rd Semester', '2020-2021', 'Philip Pope', 'Minerva Hewitt', 'Sacha Sosa', 'Erasmus Roberson', 'Casey Vargas', 'Caldwell Wilkins', 'Emerald Rosa', 'Ezekiel Wilkerson', 'Fiona Mathis', 'Sydney Wright', 'Phyllis Ferguson', 'Carolyn Bird', '--- select zila ---', NULL, NULL, 'Rerum veniam et ame', 'Voluptatibus iste no', 'Autem et dignissimos', 'Deserunt rerum quae', '36', '272', NULL, 'Autem consequat Dig', 'Repellendus Quasi v', 'Velit ipsam quasi en', 'Et ut voluptas do qu', 'Piper Conley', 'Basil Frost', 'Xerxes Patel', '12', '104', NULL, 'Qui sed sint volupta', 'Itaque est irure min', 'Doloribus proident', 'Ratione adipisci max', 0, 3321.00, 231231.00, 231.00, 'Esse mollit id ea n', ' ', ' ', ' ', ' ', 'Rerum quis nobis non', 'Accusamus eos ducimu', NULL, NULL, NULL, '2022-11-08 22:32:51', '2022-11-08 22:32:51'),
(30, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Russell Cline', '1', '4', 'assets/backend/img/student/636b2d9e96b08images (3).jpg', '203', '2', '3', 'electrical', '3rd Semester', '2020-2021', 'Mari Duran', 'Iona Zamora', 'Jonas Owen', 'Noelani Campos', 'Zenia Conrad', 'Camilla Fitzgerald', 'Nelle Sherman', 'Ali Barr', 'Dane Mathews', 'Cedric Odonnell', 'Sawyer Ball', 'Lyle Reyes', '40', '311', NULL, 'Cupidatat eos ut re', 'Qui quibusdam maxime', 'Consequatur at sit', 'Odio exercitation en', '61', '457', NULL, 'Labore cupiditate au', 'Aspernatur odio culp', 'Voluptas qui volupta', 'Rerum mollitia saepe', 'Keith Parks', 'Martena Kelley', 'Yoshio Hester', '61', '457', NULL, 'Et illo autem except', 'Elit voluptate culp', 'Enim quis quisquam o', 'Omnis nobis ut asper', 0, 123123.00, 23121.00, 3112.00, 'Dolore error in quis', ' ', ' ', ' ', ' ', 'Vero ipsum voluptate', 'Praesentium tenetur', NULL, NULL, NULL, '2022-11-08 22:33:34', '2022-11-08 22:33:34'),
(31, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Reece Ferguson', '4', '3', 'assets/backend/img/student/636b2ddaa7a71images (2).jpg', '203', '2', '3', 'electrical', '2nd Semester', '2020-2021', 'Rahim Marsh', 'Fleur Luna', 'Blair Anderson', 'Urielle Beasley', 'Victor Clements', 'Blossom Foley', 'Elliott Mcneil', 'Jemima Allison', 'Hayes Alford', 'Coby Simpson', 'Unity Owen', 'Phillip Bird', '3', '24', NULL, 'Quia recusandae Mol', 'Beatae quo elit nat', 'Lorem quo ut ut cumq', 'Eius amet odit eum', '5', '--- select upzila ---', NULL, 'Est qui alias harum', 'Quia rerum reprehend', 'Sed nulla qui magna', 'Culpa sint lorem ap', 'Sydney Lynn', 'Madonna Conrad', 'Channing Leblanc', '46', '358', NULL, 'Aliquam necessitatib', 'Porro omnis iure dol', 'Enim autem cumque se', 'Blanditiis sunt dolo', 0, 45554.00, 54545.00, 5454.00, 'Quasi recusandae Bl', ' ', ' ', ' ', ' ', 'Cum aut recusandae', 'Libero dolor enim qu', NULL, NULL, NULL, '2022-11-08 22:34:34', '2022-11-08 22:34:34'),
(32, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Joelle Chen', '1', '4', 'assets/backend/img/student/636b2e03063d4images (2).jpg', '301', '3', '5', 'electrical', '1st Semester', '2020-2021', 'Raymond Johnston', 'Macy Cruz', 'Aimee Tran', 'Flavia Schroeder', 'Deanna Buchanan', 'Adrienne Lambert', 'Bernard Frank', 'Guinevere Fulton', 'May Moody', 'Adena Chaney', 'Haviva Stanton', 'Signe Hood', '39', '300', NULL, 'Laboriosam consecte', 'Sint iste nisi adipi', 'Dolorem temporibus e', 'In quo ut velit vel', '10', '88', NULL, 'Tempora perspiciatis', 'Corrupti voluptas f', 'Anim assumenda elige', 'Sint adipisicing eos', 'Wylie Boyle', 'Mallory Moreno', 'Ignacia Riggs', '62', '462', NULL, 'Dolor doloribus nost', 'Cillum enim omnis re', 'Provident ex dolor', 'Consequatur Distinc', 0, 23121.00, 312321.00, 23121.00, 'Nesciunt facere bla', ' ', ' ', ' ', ' ', 'Est dolore voluptat', 'Eos exercitation eni', NULL, NULL, NULL, '2022-11-08 22:35:16', '2022-11-08 22:35:16'),
(33, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Blake Holmes', '4', '3', 'assets/backend/img/student/636b2e7f4018edownload (3).jpg', '302', '3', '5', 'computer', '2nd Semester', '2020-2021', 'Zeph Haley', 'Reed Mclaughlin', 'Bethany Allen', 'Daria Reilly', 'Xena Goodwin', 'Kimberly Riggs', 'Chancellor Zamora', 'Marah Mclean', 'Caesar Heath', 'Malcolm Schultz', 'Fuller Bauer', 'Nita Marsh', '45', '345', NULL, 'Qui labore autem mol', 'Qui et magni tempori', 'Nostrum rerum accusa', 'Adipisci eligendi qu', '62', '462', NULL, 'Culpa occaecat et en', 'Velit ipsum libero d', 'Alias at numquam par', 'Enim eveniet placea', 'Rhoda Christensen', 'Bernard Calderon', 'Tyler Chang', '8', '65', NULL, 'Eos mollit ipsum qu', 'A sapiente sapiente', 'Officiis in cumque a', 'Odio praesentium quo', 0, 123123.00, 31221.00, 3321.00, 'Qui nihil facere mol', ' ', ' ', ' ', ' ', 'Irure laudantium od', 'Laudantium sit aut', NULL, NULL, NULL, '2022-11-08 22:37:19', '2022-11-08 22:37:19'),
(34, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Cara Hooper', '2', '1', 'assets/backend/img/student/636b2effe081cimages (3).jpg', '303', '3', '5', 'electrical', '2nd Semester', '2020-2021', 'Ezra Cotton', 'Tanisha Patrick', 'Imani Rosales', 'Vincent Best', 'Marsden Guerra', 'Rooney Taylor', 'Lysandra Madden', 'Ina Aguilar', 'Kato Lloyd', 'Jade Abbott', 'Ina Sharpe', 'Kirk Flynn', '12', '104', NULL, 'Magnam et tenetur of', 'Tempore est quisqu', 'Ipsa et tempora cup', 'Quia nostrud sit do', '56', '422', NULL, 'Non sint quisquam e', 'Sint facere fuga V', 'Dolores dolorem qui', 'Vel molestias qui ut', 'Charissa Wyatt', 'Jaquelyn Ramos', 'Mallory Knapp', '44', '333', NULL, 'Et consectetur dolor', 'Reprehenderit autem', 'Odio veritatis harum', 'Omnis voluptatem exe', 0, 887987.00, 97887.00, 78697.00, 'Nihil veniam cum do', ' ', ' ', ' ', ' ', 'Recusandae Quo dign', 'Officiis illum itaq', NULL, NULL, NULL, '2022-11-08 22:39:28', '2022-11-08 22:39:28'),
(35, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Craig Ellis', '3', '2', 'assets/backend/img/student/636b2f30cba03images (1).jpg', '401', '4', '6', '--- select technology ---', '2nd Semester', '2020-2021', 'Kiona Hull', 'Charde Gillespie', 'Aquila Cross', 'Ross Mcguire', 'Erich David', 'Roth James', 'Lisandra Fitzpatrick', 'Wang Bruce', 'Marah Rosario', 'Lewis Boone', 'Christen Blankenship', 'Kadeem Nunez', '29', '224', NULL, 'Et asperiores saepe', 'Non est voluptatum', 'Quisquam velit omnis', 'Ut nihil ipsum qui c', '52', '390', NULL, 'Nemo dolor vel cillu', 'Autem aliqua Incidu', 'Eius et doloribus cu', 'Recusandae Culpa a', 'Ina Harmon', 'Jerry Campos', 'Inez Wade', '24', '192', NULL, 'Eos minima temporibu', 'Beatae quas perspici', 'Voluptas reprehender', 'Aperiam fuga Dolore', 0, 123123.00, 312321.00, 31221.00, 'Minim earum quae exc', ' ', ' ', ' ', ' ', 'Nihil ex sunt ullam', 'Incidunt reiciendis', NULL, NULL, NULL, '2022-11-08 22:40:18', '2022-11-08 22:40:18'),
(36, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Marah Kidd', '2', '1', 'assets/backend/img/student/636b2fc92dbf0images (4).jpg', '402', '4', '6', 'electrical', '3rd Semester', '2020-2021', 'Bernard Ellis', 'Kirestin Meyers', 'September Scott', 'Uriah Marquez', 'Hoyt Stout', 'Maxine Riggs', 'Reese Hayden', 'Gavin Page', 'Fitzgerald Ramirez', 'Odessa Copeland', 'Stone Dotson', 'Cody Castillo', '28', '215', NULL, 'Ipsum totam qui quia', 'Et quis voluptate om', 'Non minim vitae et r', 'Non placeat eligend', '14', '122', NULL, 'Aperiam mollit sequi', 'Aut aut mollit quas', 'Eos maxime maiores', 'Dolores in ad hic di', 'Prescott Burton', 'Rose Howell', 'Mariko Padilla', '40', '311', NULL, 'Lorem facilis adipis', 'Nesciunt doloribus', 'Eligendi in ut ex mo', 'Dolor sed deserunt h', 0, 123123.00, 312321.00, 312312.00, 'Aliquip debitis magn', ' ', ' ', ' ', ' ', 'Temporibus laboris m', 'Ex magni omnis nisi', NULL, NULL, NULL, '2022-11-08 22:42:49', '2022-11-08 22:42:49'),
(37, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Prescott Martin', '2', '6', 'assets/backend/img/student/636b2ffcc4b3fimages (2).jpg', '403', '4', '6', 'computer', '2nd Semester', '2020-2021', 'Ira Mclaughlin', 'Inga Ford', 'Oleg Snyder', 'Kessie May', 'Baxter Jefferson', 'Damon Stewart', 'Ashely Burgess', 'Unity York', 'Yvonne Soto', 'Randall Harris', 'Jasmine Peters', 'Jaquelyn Reilly', '1', '1', NULL, 'Illo laudantium non', 'In adipisicing labor', 'Qui sit necessitatib', 'Quas fugiat in paria', '39', '300', NULL, 'Consectetur voluptas', 'Nisi autem quo rerum', 'Mollitia quas odio m', 'Proident tempora ut', 'Victoria Brooks', 'Jenna Chapman', 'Beatrice Richards', '8', '65', NULL, 'Dolore quibusdam aut', 'Cum illo at amet de', 'Voluptatem qui quasi', 'Amet non et adipisi', 0, 13213.00, 321321.00, 31321.00, 'Quia est commodo aut', ' ', ' ', ' ', ' ', 'Placeat velit volup', 'Corporis facere veri', NULL, NULL, NULL, '2022-11-08 22:43:40', '2022-11-08 22:43:40'),
(38, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Phoebe Castillo', '4', '3', 'assets/backend/img/student/636b30339e140images (5).jpg', '501', '5', '7', '--- select technology ---', '3rd Semester', '2020-2021', 'Imogene Palmer', 'Elton Foster', 'Colorado Nash', 'Freya Hill', 'Finn Boone', 'Athena Ware', 'Xandra Marshall', 'Axel Wallace', 'Cullen Rose', 'Ginger Barr', 'Neve Massey', 'Athena Medina', '26', '202', NULL, 'Assumenda nulla rati', 'Provident velit in', 'Voluptatem voluptat', 'Et enim quo quasi su', '44', '333', NULL, 'Nulla et corrupti i', 'Adipisicing eos non', 'Non eum quis cum max', 'Et quos consequuntur', 'Jaquelyn Norton', 'Piper Davidson', 'Freya Foreman', '18', '155', NULL, 'Sapiente irure rerum', 'Tempore modi in inc', 'Maxime exercitation', 'Et cumque magni odit', 0, 2313213.00, 231231.00, 1232132.00, 'Sint aliquam id dolo', ' ', ' ', ' ', ' ', 'Velit cumque eveniet', 'Quis veniam maiores', NULL, NULL, NULL, '2022-11-08 22:44:37', '2022-11-08 22:44:37'),
(39, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Hadley Kelly', '2', '1', 'assets/backend/img/student/636b3063b05fbimages (2).jpg', '502', '5', '8', 'electrical', '1st Semester', '2020-2021', 'Mark Peterson', 'Solomon Whitehead', 'Remedios Rush', 'Hanna Chapman', 'Serena Juarez', 'Grant Tillman', 'Hannah Hart', 'Guinevere Hayden', 'Keely Hamilton', 'Winter Callahan', 'Brandon Gregory', 'Uriah Foreman', '17', '150', NULL, 'Aut assumenda porro', 'In enim porro dignis', 'Odio in quo modi ver', 'Ad at voluptatem ex', '34', '259', NULL, 'Voluptatibus maxime', 'Tempor quidem conseq', 'Veniam debitis eaqu', 'Quidem sit quia con', 'Cleo Wiggins', 'Shaine Calhoun', 'Robert Ray', '62', '462', NULL, 'Voluptatem Voluptat', 'Sed magna vitae faci', 'Fuga Excepteur labo', 'Eius dolorem commodi', 0, 213123.00, 32121.00, 32121.00, 'Corrupti vero qui i', ' ', ' ', ' ', ' ', 'Nostrum est et labo', 'Excepteur et asperio', NULL, NULL, NULL, '2022-11-08 22:45:23', '2022-11-08 22:45:23'),
(40, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Zachery Head', '3', '2', 'assets/backend/img/student/636b30a677340download (2).jpg', '503', '5', '9', 'computer', '2nd Semester', '2020-2021', 'Kasper Downs', 'Echo Holloway', 'Geoffrey Mcguire', 'Emerald Lindsey', 'Rosalyn Mills', 'Ramona Cotton', 'Xantha Haynes', 'Ryder Robles', 'Hanae Griffin', 'Lacy Moran', 'Ira Conway', 'Holmes Townsend', '1', '1', NULL, 'Veniam minima ipsum', 'Aliquip quasi volupt', 'Adipisicing aut enim', 'Ut quos illo provide', '5', '43', NULL, 'Elit molestiae adip', 'Nam dolorum harum do', 'Sapiente pariatur E', 'Quidem quo molestias', 'Naida Case', 'Amery Schmidt', 'Hilda Sawyer', '56', '422', NULL, 'Qui minim inventore', 'Accusamus explicabo', 'Dolor consequatur do', 'Sit corporis exerci', 0, 21212.00, 232131.00, 321321.00, 'Tempor nulla duis di', ' ', ' ', ' ', ' ', 'Quis distinctio Omn', 'Incididunt laboriosa', NULL, NULL, NULL, '2022-11-08 22:46:30', '2022-11-08 22:46:30'),
(41, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Julie Head', '3', '2', 'assets/backend/img/student/636b30fa35f77images (3).jpg', '201', '2', '3', 'electrical', '4th Semester', '2021-2022', 'Rowan Donaldson', 'Aquila Ellison', 'Madonna Dillon', 'Jolie Chen', 'Sybill Morgan', 'Channing Mendoza', 'Sean Bowers', 'Leonard Head', 'Ebony Hopper', 'Isabelle Potts', 'Wynne Vinson', 'Cheryl Bullock', '9', NULL, '--- select union ---', 'Voluptatem dolorem', 'Cumque in adipisci a', 'Amet tempore dolor', 'Voluptatum itaque oc', '8', NULL, '--- select union ---', 'Beatae est molestiae', 'In laudantium moles', 'Sit voluptates fugit', 'Et exercitation proi', 'Hector Kane', 'Garrett Sanford', 'Bell Solis', '15', NULL, '--- select union ---', 'Voluptatem asperior', 'Minima dolore dolori', 'Autem est aliquam pr', 'Ipsum voluptas nemo', 0, 213213.00, 23121.00, 31212.00, 'Mollit ipsa est qua', ' ', ' ', ' ', ' ', 'Id consectetur aspe', 'Ullam libero ea veli', NULL, NULL, NULL, '2022-11-08 22:47:55', '2022-11-08 22:47:55'),
(42, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Adam Avery', '2', '1', 'assets/backend/img/student/636b312869695images (3).jpg', '202', '2', '3', 'computer', '2nd Semester', '2021-2022', 'Odette Hughes', 'Ira Glenn', 'Yeo Lara', 'Zachery Guthrie', 'Irene Robertson', 'Cassady Kaufman', 'Brady Harper', 'Brittany Nash', 'Hasad Delaney', 'Karly Galloway', 'Kaseem Dixon', 'Kyra Knox', '9', '80', NULL, 'Culpa sed consequat', 'Amet sint debitis a', 'Amet rerum est ab q', 'Eaque beatae veniam', '26', '202', NULL, 'Lorem excepturi saep', 'Aut autem quidem aut', 'A consequat Velit c', 'Nisi sunt quidem se', 'Aaron Avery', 'Orson Ballard', 'Winifred Hudson', '55', '417', NULL, 'Harum provident odi', 'Fugiat est quo cons', 'Ut eu ab in reprehen', 'Sint est sit exerci', 0, 123123.00, 31212.00, 23231.00, 'Earum aperiam alias', ' ', ' ', ' ', ' ', 'Dolorem qui aut blan', 'Nostrud ipsam sed de', NULL, NULL, NULL, '2022-11-08 22:48:40', '2022-11-08 22:48:40'),
(43, NULL, 'QUALITY EDUCATION SCHOOL & COLLEGE', 'Emery Horton', '2', '1', 'assets/backend/img/student/636b315da6416images (3).jpg', '501', '5', '7', 'computer', '3rd Semester', '2021-2022', 'Irma Lawrence', 'Rhonda Ferrell', 'Stephen Tran', 'Lucius Patrick', 'Ivory Lee', 'Blake Powers', 'Gay Conner', 'Mechelle Hood', 'Dane Leon', 'Shellie Powell', 'Phillip Higgins', 'Sage Miller', '3', '24', NULL, 'Quasi sit accusamus', 'Fuga Enim facilis q', 'Animi perferendis r', 'In voluptates amet', '35', '266', NULL, 'Consequatur do nisi', 'Explicabo Nemo corr', 'Architecto animi al', 'Quidem dolorum velit', 'Arthur Scott', 'Tallulah Avila', 'Callie Vazquez', '14', '122', NULL, 'Voluptas in fugiat', 'Officia sunt volupta', 'Atque cum eum et ali', 'Et fuga Vero ea inc', 0, 123123.00, 123123.00, 31221.00, 'Eu quia ut illo ad c', ' ', ' ', ' ', ' ', 'Ut laborum Amet co', 'Ea ex perferendis pe', NULL, NULL, NULL, '2022-11-08 22:49:35', '2022-11-08 22:49:35');
...
INSERT INTO `transports` (`id`, `schhol_id`, `route_name`, `vehicle_num`, `description`, `route_fare`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 'Paki Newman', '12', 'Hic ut id nisi et re', 'Daria Matthews', 1, '2022-11-23 00:56:40', '2022-11-23 01:01:46');
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `phone`, `image`, `gender`, `dob`, `status`, `email_verified_at`, `password`, `deleted_at`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 1, 'Admin', 'admin@gmail.com', NULL, NULL, NULL, NULL, 1, NULL, '$2y$10$.MoQEfxnfbhWainDc17bhuDmdUdJRnA6JXWCfzb9nVd99D9SwLsBe', NULL, NULL, '2022-11-12 02:09:05', '2022-11-12 02:09:05'),
(2, 2, 'User', 'user@gmail.com', NULL, NULL, NULL, NULL, 1, NULL, '$2y$10$y.fW4hFD0U2DNZFxNThW6uL6GfwJ/nZEJD4x/YkPjf9LnZRT2vghe', NULL, NULL, '2022-11-12 02:09:05', '2022-11-12 02:09:05'),
(7, 1, 'Md Rabbi Hasan', 'mdrabbihasan610@gmail.com', NULL, NULL, NULL, NULL, 1, NULL, '$2y$10$RMN0rir.DDUwrzDXkxK1vOpUujGNvjPT62EoQC62SUpibYQlgR3rK', NULL, NULL, NULL, '2022-11-18 23:54:37');
...
--
-- Indexes for table `2019-2020_2_students`
--
ALTER TABLE `2019-2020_2_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2019_2020_2_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `2019-2020_3_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2019_2020_3_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `2019-2020_4_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2019_2020_4_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `2019-2020_5_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2019_2020_5_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `2020-2021_2_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2020_2021_2_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `2020-2021_3_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2020_2021_3_students_student_id_foreign` (`student_id`);
...
ALTER TABLE `2020-2021_5_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2020_2021_5_students_student_id_foreign` (`student_id`);
...
--
-- Indexes for table `2021-2022_5_students`
--
ALTER TABLE `2021-2022_5_students`
  ADD PRIMARY KEY (`id`),
  ADD KEY `2021_2022_5_students_student_id_foreign` (`student_id`);
...
--
-- AUTO_INCREMENT for table `2019-2020_2_students`
--
ALTER TABLE `2019-2020_2_students`
...
--
-- AUTO_INCREMENT for table `2021-2022_5_students`
--
ALTER TABLE `2021-2022_5_students`
...
--
-- Constraints for table `2019-2020_2_students`
--
ALTER TABLE `2019-2020_2_students`
  ADD CONSTRAINT `2019_2020_2_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `2019-2020_3_students`
--
ALTER TABLE `2019-2020_3_students`
  ADD CONSTRAINT `2019_2020_3_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `2019-2020_4_students`
--
ALTER TABLE `2019-2020_4_students`
  ADD CONSTRAINT `2019_2020_4_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `2019-2020_5_students`
--
ALTER TABLE `2019-2020_5_students`
  ADD CONSTRAINT `2019_2020_5_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `2020-2021_2_students`
--
ALTER TABLE `2020-2021_2_students`
  ADD CONSTRAINT `2020_2021_2_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `2020-2021_3_students`
--
ALTER TABLE `2020-2021_3_students`
  ADD CONSTRAINT `2020_2021_3_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `2020-2021_5_students`
--
ALTER TABLE `2020-2021_5_students`
  ADD CONSTRAINT `2020_2021_5_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `2021-2022_5_students`
--
ALTER TABLE `2021-2022_5_students`
  ADD CONSTRAINT `2021_2022_5_students_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;
